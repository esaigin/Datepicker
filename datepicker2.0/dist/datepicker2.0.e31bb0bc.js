...
var _renderMounth = new WeakSet();

var _renderYears = new WeakSet();
...
var DatePicker = /*#__PURE__*/function () {
  ...
  function DatePicker(selector, options) {
    ...
    _renderYears.add(this);

    _renderMounth.add(this);
  ...
  _createClass(DatePicker, [{
    ...
    value: function handleClick(event) {
      ...
      if (type === 'mounth_m') {
        ...
        _classPrivateMethodGet(this, _renderYears, _renderYears2).call(this);
      }
      ...
      if (type === 'mounth') {
        if (this.$vis === 0) {
          _classPrivateMethodGet(this, _renderMounth, _renderMounth2).call(this);
        } else if (this.$vis === 1) {
          _classPrivateMethodGet(this, _renderYears, _renderYears2).call(this);
        } else if (this.$vis === 2) {
          _classPrivateMethodGet(this, _renderDates, _renderDates2).call(this);
...
var _setup2 = function _setup2() {
  ...
  var d = ('0' + this.day).slice(-2);
  this.$input.textContent = "".concat(d, ".").concat(m, ".").concat(this.year);
  this.$content = this.$el.querySelector('[data-type="content"]'); // this.$mounth.addEventListener('click' this.handle)
...
var _renderDates2 = function _renderDates2() {
  ...
  for (var i = 0; i < 7; i++) {
    str += "<div class=\"days\">".concat(days[i], "</div>");
  }

  for (var _i = 0; _i < this.first_wday - 1; _i++) {
    str += "<div class=\"disabled\"> </div>";
  }

  for (var _i2 = 1; _i2 < this.last_date; _i2++) {
    str += "<div data-type=\"date\">".concat(_i2, "</div>");
  }
...
var _renderMounth2 = function _renderMounth2() {
  var template = "";
  template = mounts.map(function (m) {
    return "<div data-type=\"mounth_m\">".concat(m, "</div>");
  }).join('');
  this.$content.innerHTML = "<div class=\"mounth_grid\">" + template + "</div>";
  this.$vis = 1;
};

var _renderYears2 = function _renderYears2() {
  var template = "";
  template = Array(100).fill().map(function (e, i) {
    return i + 1930;
  }).map(function (m) {
    return "<div data-type=\"year_m\">".concat(m, "</div>");
  }).join('');
  this.$content.innerHTML = "<div class=\"year_grid\">" + template + "</div>";
  this.$vis = 2;
};
},{"../img/prev.png":"img/prev.png","../img/next.png":"img/next.png"}],"../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"datepicker/index.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./datepicker/DatePicker":"datepicker/DatePicker.js","./datepicker/index.css":"datepicker/index.css"}],"../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../Users/Егор Сайгин/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/datepicker2.0.e31bb0bc.js.map